...
- [x] **Dynamic Pre-boarding (Intake Forms/Menus)**: While waiting in the digital queue, serve the customer the business's digital menu or preliminary paperwork (like a clinic intake form). When it's their turn, their order/paperwork is automatically attached to their token, saving massive amounts of physical time.
...
- [x] **Smart "Snooze" (Traffic Delay)**: If a customer is stuck in transit or needs a little more time, they can hit a "Snooze" button. This bumps them back exactly 2-3 spots in line without losing their place completely or holding up the queue.
